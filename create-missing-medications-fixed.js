...
async function createMissingMedicationsFixed() {
    let client;
    try {
        ...
        // Get Natan Kinfe's patient ID using firstName and lastName
        ...
        const patientName = `${natanPatient.firstName} ${natanPatient.lastName}`;
        ...
        for (const med of activeMedications) {
            ...
            const nurseTask = {
                ...
                patientName: patientName,
                taskType: 'MEDICATION',
                description: `Administer ${med.name} to ${patientName}`,
                status: 'PENDING',
                priority: 'MEDIUM',
                assignedBy: 'system',
        ...
        for (const med of bidExtendedMedications) {
            ...
            const nurseTask = {
                ...
                patientName: patientName,
                taskType: 'MEDICATION',
                description: `Administer ${med.name} to ${patientName} (Extended)`,
                status: 'PENDING',
                priority: 'MEDIUM',
                assignedBy: 'system',
                assignedByName: 'System',
