...
const validate = {
  user: {
    ...
    update: [
      ...
      body('digitalSignature').optional({ nullable: true }).custom((val) => val === null || (typeof val === 'string' && val.length <= 10000000)).withMessage('Digital signature must be a valid base64 string (max 10MB)'),
      processValidationErrors
    ],
