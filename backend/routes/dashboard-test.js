...
// @desc    Get patient count statistics (test version)
// @access  Private
router.get('/patients/count', auth, async (req, res) => {
  try {
    res.json({
      success: true,
      data: {
...
// @desc    Get staff count by role (test version)
// @access  Private
router.get('/staff/count', auth, async (req, res) => {
  try {
    res.json({
      success: true,
      data: {
...
// @desc    Get pending tasks statistics (test version)
// @access  Private
...
// @desc    Get laboratory test statistics (test version)
// @access  Private
router.get('/lab/stats', auth, async (req, res) => {
  try {
    res.json({
      success: true,
      data: {
...
// @desc    Get billing and revenue statistics (test version)
// @access  Private
router.get('/billing/revenue-stats', auth, async (req, res) => {
  try {
    res.json({
      success: true,
      data: {
...
// @desc    Get notification statistics (test version)
// @access  Private
...
// @desc    Get appointment count statistics (test version)
// @access  Private
...
// @desc    Get comprehensive dashboard statistics for admin (test version)
// @access  Private (Admin only)
router.get('/admin/dashboard/stats', auth, async (req, res) => {
  try {
