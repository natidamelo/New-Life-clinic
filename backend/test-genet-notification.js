...
async function testGenetNotification() {
  try {
    console.log('🧪 Testing Lab Order Notification for genet hailu...\n');
    
    await mongoose.connect(process.env.MONGODB_URI);
    console.log('✅ Connected to MongoDB');

    // Test data matching genet's lab order
    const testData = {
      patientId: 'P000006',
    ...
    console.log('📱 Sending lab order notification for genet hailu...');
    ...
    if (result.success) {
      console.log('🎉 SUCCESS! Staff should have received the lab order notification for genet hailu!');
