...
' Build frontend command using npm run start
frontendCmd = "cmd /c cd /d """ & frontendDir & """ && npm run start >> """ & frontendLogDir & "\startup.out.log"" 2>> """ & frontendLogDir & "\startup.err.log"""
