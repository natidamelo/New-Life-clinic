...
export type ColorTheme = 'default-light' | 'default-dark' | 'aqua' | 'teal' | 'light-blue' | 'rose' | 'pink' | 'gold' | 'orange' | 'charcoal' | 'navy' | 'indigo' | 'purple' | 'maroon' | 'forest-green' | 'blue' | 'green' | 'red' | 'gray' | 'slate' | 'zinc' | 'neutral' | 'stone' | 'emerald' | 'cyan' | 'sky' | 'violet' | 'fuchsia' | 'amber' | 'lime' | 'cool-breeze' | 'icy-mint' | 'midnight' | 'steel' | 'turquoise' | 'peacock' | 'coral' | 'terracotta' | 'lavender' | 'plum' | 'mauve' | 'jade' | 'sage' | 'olive' | 'copper' | 'bronze' | 'champagne' | 'crimson' | 'sapphire' | 'cobalt' | 'custom';
...
export const colorThemes: ColorThemeConfig[] = [
  ...
  // ── Expanded palette ──────────────────────────────────────────────────
  {
    ...
    accent: 'hsl(222 47% 95%)',
    accentForeground: 'hsl(222 47% 11%)',
    muted: 'hsl(222 47% 95%)',
    mutedForeground: 'hsl(222 30% 45%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(222 47% 5%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(222 47% 5%)',
    border: 'hsl(222 47% 90%)',
    input: 'hsl(222 47% 90%)',
    ring: 'hsl(222 47% 11%)',
  },
  {
    ...
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(215 16% 95%)',
    secondaryForeground: 'hsl(215 16% 10%)',
    accent: 'hsl(215 16% 95%)',
    accentForeground: 'hsl(215 16% 10%)',
    muted: 'hsl(215 16% 95%)',
    mutedForeground: 'hsl(215 12% 45%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(215 16% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(215 16% 10%)',
  ...
  },
  {
    ...
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(174 60% 95%)',
    secondaryForeground: 'hsl(174 60% 10%)',
    accent: 'hsl(174 60% 95%)',
    accentForeground: 'hsl(174 60% 10%)',
    muted: 'hsl(174 60% 95%)',
    mutedForeground: 'hsl(174 40% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(174 60% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(174 60% 10%)',
    border: 'hsl(174 60% 90%)',
    input: 'hsl(174 60% 90%)',
    ring: 'hsl(174 60% 51%)',
  },
  {
    name: 'Peacock',
    value: 'peacock',
    primary: 'hsl(192 91% 29%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(192 91% 95%)',
    secondaryForeground: 'hsl(192 91% 10%)',
    accent: 'hsl(192 91% 95%)',
    accentForeground: 'hsl(192 91% 10%)',
    muted: 'hsl(192 91% 95%)',
    mutedForeground: 'hsl(192 50% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(192 91% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(192 91% 10%)',
    border: 'hsl(192 91% 90%)',
    input: 'hsl(192 91% 90%)',
    ring: 'hsl(192 91% 29%)',
  },
  {
    ...
    primary: 'hsl(4 86% 68%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(4 86% 95%)',
    secondaryForeground: 'hsl(4 86% 15%)',
    accent: 'hsl(4 86% 95%)',
    accentForeground: 'hsl(4 86% 15%)',
    muted: 'hsl(4 86% 95%)',
    mutedForeground: 'hsl(4 50% 45%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(4 86% 15%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(4 86% 15%)',
    border: 'hsl(4 86% 90%)',
    input: 'hsl(4 86% 90%)',
    ring: 'hsl(4 86% 68%)',
  },
  {
    ...
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(20 90% 95%)',
    secondaryForeground: 'hsl(20 90% 10%)',
    accent: 'hsl(20 90% 95%)',
    accentForeground: 'hsl(20 90% 10%)',
    muted: 'hsl(20 90% 95%)',
    mutedForeground: 'hsl(20 50% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(20 90% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(20 90% 10%)',
    border: 'hsl(20 90% 90%)',
    input: 'hsl(20 90% 90%)',
    ring: 'hsl(20 90% 40%)',
  },
  {
    name: 'Lavender',
    value: 'lavender',
    primary: 'hsl(263 70% 71%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(263 70% 95%)',
    secondaryForeground: 'hsl(263 70% 15%)',
    accent: 'hsl(263 70% 95%)',
    accentForeground: 'hsl(263 70% 15%)',
    muted: 'hsl(263 70% 95%)',
    mutedForeground: 'hsl(263 40% 45%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(263 70% 15%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(263 70% 15%)',
    border: 'hsl(263 70% 90%)',
    input: 'hsl(263 70% 90%)',
    ring: 'hsl(263 70% 71%)',
  },
  {
    name: 'Plum',
    value: 'plum',
    primary: 'hsl(270 91% 47%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(270 91% 95%)',
    secondaryForeground: 'hsl(270 91% 10%)',
    accent: 'hsl(270 91% 95%)',
    accentForeground: 'hsl(270 91% 10%)',
    muted: 'hsl(270 91% 95%)',
    mutedForeground: 'hsl(270 50% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(270 91% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(270 91% 10%)',
    border: 'hsl(270 91% 90%)',
    input: 'hsl(270 91% 90%)',
    ring: 'hsl(270 91% 47%)',
  },
  {
    name: 'Mauve',
    value: 'mauve',
    primary: 'hsl(270 67% 75%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(270 67% 95%)',
    secondaryForeground: 'hsl(270 67% 15%)',
    accent: 'hsl(270 67% 95%)',
    accentForeground: 'hsl(270 67% 15%)',
    muted: 'hsl(270 67% 95%)',
    mutedForeground: 'hsl(270 40% 45%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(270 67% 15%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(270 67% 15%)',
    border: 'hsl(270 67% 90%)',
    input: 'hsl(270 67% 90%)',
    ring: 'hsl(270 67% 75%)',
  },
  {
    ...
    secondaryForeground: 'hsl(158 64% 10%)',
    accent: 'hsl(158 64% 95%)',
    accentForeground: 'hsl(158 64% 10%)',
    muted: 'hsl(158 64% 95%)',
    mutedForeground: 'hsl(158 40% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(158 64% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(158 64% 10%)',
    border: 'hsl(158 64% 90%)',
    input: 'hsl(158 64% 90%)',
    ring: 'hsl(158 64% 32%)',
  },
  {
    name: 'Sage',
    value: 'sage',
    primary: 'hsl(80 61% 50%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(80 61% 95%)',
    secondaryForeground: 'hsl(80 61% 10%)',
    accent: 'hsl(80 61% 95%)',
    accentForeground: 'hsl(80 61% 10%)',
    muted: 'hsl(80 61% 95%)',
    mutedForeground: 'hsl(80 40% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(80 61% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(80 61% 10%)',
    border: 'hsl(80 61% 90%)',
    input: 'hsl(80 61% 90%)',
    ring: 'hsl(80 61% 50%)',
  },
  {
    name: 'Olive',
    value: 'olive',
    primary: 'hsl(85 78% 38%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(85 78% 95%)',
    secondaryForeground: 'hsl(85 78% 10%)',
    accent: 'hsl(85 78% 95%)',
    accentForeground: 'hsl(85 78% 10%)',
    muted: 'hsl(85 78% 95%)',
    mutedForeground: 'hsl(85 40% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(85 78% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(85 78% 10%)',
    border: 'hsl(85 78% 90%)',
    input: 'hsl(85 78% 90%)',
    ring: 'hsl(85 78% 38%)',
  },
  {
    name: 'Copper',
    value: 'copper',
    primary: 'hsl(29 60% 46%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(29 60% 95%)',
    secondaryForeground: 'hsl(29 60% 10%)',
    accent: 'hsl(29 60% 95%)',
    accentForeground: 'hsl(29 60% 10%)',
    muted: 'hsl(29 60% 95%)',
    mutedForeground: 'hsl(29 40% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(29 60% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(29 60% 10%)',
    border: 'hsl(29 60% 90%)',
    input: 'hsl(29 60% 90%)',
    ring: 'hsl(29 60% 46%)',
  },
  {
    name: 'Bronze',
    value: 'bronze',
    primary: 'hsl(16 56% 40%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(16 56% 95%)',
    secondaryForeground: 'hsl(16 56% 10%)',
    accent: 'hsl(16 56% 95%)',
    accentForeground: 'hsl(16 56% 10%)',
    muted: 'hsl(16 56% 95%)',
    mutedForeground: 'hsl(16 40% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(16 56% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(16 56% 10%)',
    border: 'hsl(16 56% 90%)',
    input: 'hsl(16 56% 90%)',
    ring: 'hsl(16 56% 40%)',
  },
  {
    ...
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(40 50% 95%)',
    secondaryForeground: 'hsl(40 50% 10%)',
    accent: 'hsl(40 50% 95%)',
    accentForeground: 'hsl(40 50% 10%)',
    muted: 'hsl(40 50% 95%)',
    mutedForeground: 'hsl(40 30% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(40 50% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(40 50% 10%)',
    border: 'hsl(40 50% 90%)',
    input: 'hsl(40 50% 90%)',
    ring: 'hsl(40 50% 55%)',
  },
  {
    ...
    primary: 'hsl(0 72% 51%)',
    primaryForeground: 'hsl(0 0% 98%)',
    secondary: 'hsl(0 72% 95%)',
    secondaryForeground: 'hsl(0 72% 10%)',
    accent: 'hsl(0 72% 95%)',
    accentForeground: 'hsl(0 72% 10%)',
    muted: 'hsl(0 72% 95%)',
    mutedForeground: 'hsl(0 50% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(0 72% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(0 72% 10%)',
    border: 'hsl(0 72% 90%)',
    input: 'hsl(0 72% 90%)',
    ring: 'hsl(0 72% 51%)',
  },
  {
    ...
    secondaryForeground: 'hsl(217 91% 10%)',
    accent: 'hsl(217 91% 95%)',
    accentForeground: 'hsl(217 91% 10%)',
    muted: 'hsl(217 91% 95%)',
    mutedForeground: 'hsl(217 50% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(217 91% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(217 91% 10%)',
  ...
  },
  {
    ...
    secondaryForeground: 'hsl(224 76% 10%)',
    accent: 'hsl(224 76% 95%)',
    accentForeground: 'hsl(224 76% 10%)',
    muted: 'hsl(224 76% 95%)',
    mutedForeground: 'hsl(224 50% 40%)',
    background: 'hsl(0 0% 100%)',
    foreground: 'hsl(224 76% 10%)',
    card: 'hsl(0 0% 100%)',
    cardForeground: 'hsl(224 76% 10%)',
    border: 'hsl(224 76% 90%)',
    input: 'hsl(224 76% 90%)',
    ring: 'hsl(224 76% 48%)',
  },
];
