...
const NurseReport: React.FC = () => {
  ...
  const handleExportReport = () => {
    ...
    const printContent = `
      ...
      <html>
      <head>
        <title>${reportType === 'monthly' ? 'Monthly' : 'Weekly'} Report - ${clinic?.fullName || clinic?.name || 'New Life Medium Clinic'}</title>
        <style>
          body {
      ...
      <body>
       ...
       <div class="page-break">
         ...
         <table class="avoid-break">
           ...
           <p>Report generated by ${clinic?.name || 'New Life Medium Clinic'} Management System</p>
